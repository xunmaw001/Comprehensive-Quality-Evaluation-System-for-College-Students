<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="必修课学分" prop="bixiukexuefen">
          <el-input v-model="ruleForm.bixiukexuefen" 
              placeholder="必修课学分" clearable  :readonly="ro.bixiukexuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="必修课学分" prop="bixiukexuefen">
              <el-input v-model="ruleForm.bixiukexuefen" 
                placeholder="必修课学分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="选修课学分" prop="xuanxiukexuefen">
          <el-input v-model="ruleForm.xuanxiukexuefen" 
              placeholder="选修课学分" clearable  :readonly="ro.xuanxiukexuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="选修课学分" prop="xuanxiukexuefen">
              <el-input v-model="ruleForm.xuanxiukexuefen" 
                placeholder="选修课学分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加分项目名称" prop="jiafenxiangmumingcheng">
          <el-input v-model="ruleForm.jiafenxiangmumingcheng" 
              placeholder="加分项目名称" clearable  :readonly="ro.jiafenxiangmumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加分项目名称" prop="jiafenxiangmumingcheng">
              <el-input v-model="ruleForm.jiafenxiangmumingcheng" 
                placeholder="加分项目名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所加学分" prop="suojiaxuefen">
          <el-input v-model="ruleForm.suojiaxuefen" 
              placeholder="所加学分" clearable  :readonly="ro.suojiaxuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所加学分" prop="suojiaxuefen">
              <el-input v-model="ruleForm.suojiaxuefen" 
                placeholder="所加学分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="总学分" prop="zongxuefen">
            <el-input v-model="zongxuefen"
                placeholder="总学分" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zongxuefen" label="总学分" prop="zongxuefen">
              <el-input v-model="ruleForm.zongxuefen" 
                placeholder="总学分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="毕业状态" prop="biyezhuangtai">
          <el-select v-model="ruleForm.biyezhuangtai" placeholder="请选择毕业状态">
            <el-option
                v-for="(item,index) in biyezhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="毕业状态" prop="biyezhuangtai">
	      <el-input v-model="ruleForm.biyezhuangtai"
                placeholder="毕业状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	bixiukexuefen : false,
	xuanxiukexuefen : false,
	jiafenxiangmumingcheng : false,
	suojiaxuefen : false,
	zongxuefen : false,
	biyezhuangtai : false,
	dengjiriqi : false,
  ...
  computed: {
    zongxuefen: {
      get: function () {
        return 0+parseFloat(this.ruleForm.bixiukexuefen==""?0:this.ruleForm.bixiukexuefen)+parseFloat(this.ruleForm.xuanxiukexuefen==""?0:this.ruleForm.xuanxiukexuefen)+parseFloat(this.ruleForm.suojiaxuefen==""?0:this.ruleForm.suojiaxuefen) || 0
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xueshengxingming = true;
          ...
          if(o=='bixiukexuefen'){
            this.ruleForm.bixiukexuefen = obj[o];
	    this.ro.bixiukexuefen = true;
            continue;
          }
          if(o=='xuanxiukexuefen'){
            this.ruleForm.xuanxiukexuefen = obj[o];
	    this.ro.xuanxiukexuefen = true;
            continue;
          }
          if(o=='jiafenxiangmumingcheng'){
            this.ruleForm.jiafenxiangmumingcheng = obj[o];
	    this.ro.jiafenxiangmumingcheng = true;
            continue;
          }
          if(o=='suojiaxuefen'){
            this.ruleForm.suojiaxuefen = obj[o];
	    this.ro.suojiaxuefen = true;
            continue;
          }
          if(o=='zongxuefen'){
            this.ruleForm.zongxuefen = obj[o];
	    this.ro.zongxuefen = true;
            continue;
          }
          if(o=='biyezhuangtai'){
            this.ruleForm.biyezhuangtai = obj[o];
	    this.ro.biyezhuangtai = true;
            continue;
          }
          if(o=='dengjiriqi'){
      ...
      this.$http({
		...
		if(json.jiaoshixingming!=''&&json.jiaoshixingming){
          ...
          this.$message.error(data.msg);
            ...
            this.biyezhuangtaiOptions = "毕业,肄业".split(',')
    },
    // 下二随
    xuehaoChange () {
      this.$http({
    ...
    onSubmit() {
      ...
      // ${column.compare}
      // ${column.compare}
        this.ruleForm.zongxuefen = this.zongxuefen
      // ${column.compare}
      // ${column.compare}
      // ${column.compare}
