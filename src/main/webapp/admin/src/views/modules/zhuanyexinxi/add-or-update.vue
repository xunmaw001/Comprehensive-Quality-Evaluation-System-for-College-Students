<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="课程介绍" prop="kechengjieshao">
          <el-input v-model="ruleForm.kechengjieshao" 
              placeholder="课程介绍" clearable  :readonly="ro.kechengjieshao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="课程介绍" prop="kechengjieshao">
              <el-input v-model="ruleForm.kechengjieshao" 
                placeholder="课程介绍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengxiangqing = this.ruleForm.kechengxiangqing.replace(reg,'../../../ssma0chr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
