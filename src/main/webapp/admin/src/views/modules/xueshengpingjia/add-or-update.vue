    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="评价" prop="pingjia">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.pingjia" label="评价" prop="pingjia">
                    <span v-html="ruleForm.pingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.pingjia = this.ruleForm.pingjia.replace(reg,'../../../ssma0chr/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
