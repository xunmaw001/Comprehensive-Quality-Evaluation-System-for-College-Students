...
public class XueshengpingjiaController {
    ...
    public R page(@RequestParam Map<String, Object> params,XueshengpingjiaEntity xueshengpingjia, 
		...
		if(tableName.equals("jiaoshi")) {
			xueshengpingjia.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XueshengpingjiaEntity xueshengpingjia, HttpServletRequest request){
        EntityWrapper<XueshengpingjiaEntity> ew = new EntityWrapper<XueshengpingjiaEntity>();
		PageUtils page = xueshengpingjiaService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xueshengpingjia), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<XueshengpingjiaEntity> wrapper = new EntityWrapper<XueshengpingjiaEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = xueshengpingjiaService.selectCount(wrapper);
